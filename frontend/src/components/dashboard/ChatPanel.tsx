        ...
        <div className="mx-auto max-w-4xl">
          <div className="flex items-end gap-3 rounded-[1.5rem] border border-aura-border bg-aura-bg-soft p-3 shadow-aura-soft">
            <textarea
              ...
              className="aura-scrollbar min-h-[44px] max-h-[72px] flex-1 resize-none overflow-y-hidden bg-transparent px-3 py-3 text-sm font-medium leading-6 text-aura-text outline-none placeholder:text-aura-dim focus:overflow-y-auto [&:not(:placeholder-shown)]:overflow-y-auto"
            />
